(function() {
  var VERSION, action, cli, config, configName, configuration, error, errors, fs, initialConfig, params, path, positionals, program, routes, server, showUsage, writer, _base, _i, _len, _ref, _ref2;
