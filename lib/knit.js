(function() {
  var VERSION, action, cli, error, errors, fs, knit, log, module, params, path, positionals, program, resourceName, resources, showAvailableResources, showUsage, _i, _len, _ref;
