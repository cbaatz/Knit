(function() {
  var VERSION, action, builder, cli, compilers, config, dir, error, errors, fs, loadConfig, loadResources, params, path, positionals, previewer, program, server, showUsage, _i, _len, _ref;
