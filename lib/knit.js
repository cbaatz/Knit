(function() {
  var VERSION, action, cli, error, errors, flatten, fs, knit, log, params, path, positionals, program, resource, resourceName, resources, server, showAvailableResources, showUsage, writer, _i, _len, _ref, _ref2;
