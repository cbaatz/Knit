(function() {
  var cleanResources, http, log, p, startServer;
  ...
  exports.serve = function(config, resources) {
    var cleaned, handler, loadResources, path, proxyName, _ref, _ref2, _ref3, _ref4, _ref5;
    ...
    if (typeof resources === 'function') {
      loadResources = function() {
        return cleanResources(resources());
      };
    } else {
  ...
  startServer = function(config, loadResources) {
    var proxyName;
    proxyName = "" + config.proxyHost + ":" + config.proxyPort;
    return http.createServer(function(req, res) {
      var handler, poptions, preq, resources, url;
